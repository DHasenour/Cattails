...
void report( struct domain * theDomain ){
   ...
   for( i=imin ; i<imax ; ++i ){
      ...
      XMassCOgroup += theCells[i].cons[XXX+1];
      XMassCOgroup += theCells[i].cons[XXX+2];
      XMassCOgroup += theCells[i].cons[XXX+3];
      XMassSigroup += theCells[i].cons[XXX+4];
      XMassSigroup += theCells[i].cons[XXX+5];
      XMassSigroup += theCells[i].cons[XXX+6];
      XMassSigroup += theCells[i].cons[XXX+7];
      XMassSigroup += theCells[i].cons[XXX+8];
      XMassFegroup += theCells[i].cons[XXX+9];
      XMassFegroup += theCells[i].cons[XXX+10];
      XMassFegroup += theCells[i].cons[XXX+11];
      XMassNi      += theCells[i].cons[XXX+12];
